...
$(document).ready(function(){
  ...
  function resizeCalendar() {
      var currentView = $('#calendarView').fullCalendar('getView');
  ...
  $("#calendarView").fullCalendar({
    eventSources: [
      {
          url: '../whats-on/events-conferences.json',
          color: '#2ecc71',   // an option!
          textColor: 'white' // an option!
      },
      {
          url: '../whats-on/events-seminars.json',
          color: '#d35400',   // an option!
          textColor: 'white' // an option!
      }
    ],
    ...
    allDaySlot: false,
    firstDay: 1, // Monday
    hiddenDays: [ 0, 4, 5, 6 ], // Hide sun, thu, fri, sat
    minTime: 10,
    maxTime: 17,
    //timeFormat: false,
    slotMinutes: 15,
